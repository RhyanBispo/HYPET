    ...
    <nav id="menu">
        <ul>
            ...
            <li>
                ...
                ?>
                <a class="cad" href="cadPet.php">CADASTRO DE PET</a>
...
<body>
   ...
   // ?>
    ...
    <form method = "POST" action= "index_cliente.php">
    ...
    <?php
        ...
        if ( isset($_POST["btnPesq"])) {
            ...
            if ( mysqli_num_rows($resultado) > 0 ) {
                echo "<TABLE border=1>";
                echo "<TR><TH>ID</TH><TH>Nome</TH><TH>Rua</TH><TH>Bairro</TH><TH>Número</TH><TH>Preço</TH><TH>Descrição</TH><TH>RESERVAR</TH></TR>";
                while ($registro = mysqli_fetch_assoc($resultado)){
                    ...
                    echo "<TD><a class='cad' href='TelaReserva.php?idHospedagem=$id_hospedagem'>RESERVAR</a></TD>";
                    echo "</TR>";
...
/*
    ...
    <?php
        ...
        if ( isset($_POST["btnPesq2"])) {
            ...
            $pesq = $_POST["txtPesquisar"];
            $conexao = conectarBD();
            $resultado = pesquisarUsuario($conexao, $tipo, $pesq, $id_Cliente);
